...
#Create vector of desired countries and filter by it to create subset dataframe
target_countries <- c("Ecuador", "Mexico", "Honduras", "Costa Rica")
subset_imports <- tilapia_imports %>% filter(country %in% target)

#Graph and save to figs folder
